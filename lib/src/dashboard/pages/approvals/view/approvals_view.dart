...
class ApprovalsView extends StatefulWidget {
  const ApprovalsView({Key? key}) : super(key: key);
...
class _ApprovalsViewState extends State<ApprovalsView> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      requestDataGridSource = ApprovalsDataGridSource(isWebOrDesktop: true);
      Get.forceAppUpdate();
    });
    super.initState();
  }
  ...
  Widget searchField(BookingsVm vm) {
  ...
  Widget filterStatusButton(
      {required String name, required int index, required BookingsVm vm}) {
    return InkWell(
      onTap: () {
        setState(() {
