...
import 'package:yacht_master_admin/src/dashboard/pages/approvals/view/widgets/approvals_data_grid_source.dart';
...
late ApprovalsDataGridSource requestDataGridSource;

class ApprovalsGrid extends SampleView {
  const ApprovalsGrid({Key? key}) : super(key: key);

  @override
  RequestGridState createState() => RequestGridState();
}

class RequestGridState extends SampleViewState {
    ...
    return SfDataGridTheme(
      ...
      child: SfDataGrid(
        ...
        columns: <GridColumn>[
          ...
          _gridColumn(columnName: 'booked_by', width: 120),
          _gridColumn(columnName: 'charter_owner', width: 160),
          _gridColumn(columnName: 'info', width: 160),
    ...
    return GridColumn(
      ...
      label: Container(
        ...
        child: Text(
          ...
          style: R.textStyles
              .poppins(fs: AdaptiveTextSize.getAdaptiveTextSize(context, 15)),
        ),
      ),
    );
  }
  ...
  Widget _buildDataPager() {
    return SfDataPagerTheme(
      ...
      child: SfDataPager(
        ...
        delegate: requestDataGridSource,
        availableRowsPerPage: const <int>[10, 20, 25],
        visibleItemsCount: 5,
        pageCount: (requestDataGridSource.tickets.length / _rowsPerPage)
            .ceilToDouble(),
