...
class ApprovalsDialogue extends StatefulWidget {
  final BookingsModel model;
  const ApprovalsDialogue({Key? key, required this.model}) : super(key: key);

  @override
  State<ApprovalsDialogue> createState() => _ApprovalsDialogueState();
}

class _ApprovalsDialogueState extends State<ApprovalsDialogue> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.model.paymentDetail == null ||
                widget.model.paymentDetail!.cryptoScreenShot == "")
              Text(
              ...
              children: [
                Text(
                  DateFormat("dd/MM/yyyy hh:mm a").format(
                      bookingsModel.schedule?.dates?.first.toDate() ??
                          DateTime.now()),
                  style: R.textStyles.poppins(
                      fs: AdaptiveTextSize.getAdaptiveTextSize(context, 15),
                      color: R.colors.white),
                ...
                Text(
                  DateFormat("dd/MM/yyyy hh:mm a").format(
                      bookingsModel.schedule?.dates?.last.toDate() ??
                          DateTime.now()),
                  style: R.textStyles.poppins(
                      fs: AdaptiveTextSize.getAdaptiveTextSize(context, 15),
                      color: R.colors.white),
  ...
  String getStartingFromText() {
    CharterModel? charter = context.read<UserVM>().allCharters.firstWhereOrNull(
        (element) => element.id == widget.model.charterFleetDetail?.id);
    String text = '';
